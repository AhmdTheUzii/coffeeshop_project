...
public final class menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnpmbyr = new javax.swing.JButton();
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/auth/favicon-32x32.png"))); // NOI18N
        ...
        jTextArea.setRows(5);
        jTextArea.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                jTextAreaComponentShown(evt);
            }
        });
            ...
            .addGroup(jPanel26Layout.createSequentialGroup()
                ...
                .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel26Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel26Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextField2Tax, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextField1sub, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextField3Total, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        ...
        jScrollPane2.setPreferredSize(new java.awt.Dimension(466, 740));

        jPanel3.setBackground(new java.awt.Color(204, 204, 255));
        jPanel3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        jPanel3.setPreferredSize(new java.awt.Dimension(465, 740));
        ...
        jLabel7.setText("chicken carbonara");
        ...
        jLabel13.setText("chicken katsu curry");
        ...
        jLabel31.setText("chicken pop matah");
        ...
        jLabel37.setText("chicken teriyaki");
        ...
        jLabel55.setText("nasi cumi cabai hijau");
        ...
        jLabel85.setText("ice strawberry tea");
        ...
        jLabel103.setText("ice vanilla latte");
        ...
        jLabel127.setText(" kopi susu creamy");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jPanel26, javax.swing.GroupLayout.PREFERRED_SIZE, 368, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnpmbyr.setBackground(new java.awt.Color(51, 51, 51));
        btnpmbyr.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        btnpmbyr.setForeground(new java.awt.Color(255, 255, 255));
        btnpmbyr.setText("Pay");
        btnpmbyr.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnpmbyrActionPerformed(evt);
            }
        });
        ...
        jPanel25Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel25Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnpmbyr, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel25Layout.setVerticalGroup(
            ...
            .addGroup(jPanel25Layout.createSequentialGroup()
                ...
                .addGroup(jPanel25Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnpmbyr, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void jCheckBox21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox21ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox21.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel127.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox21.setSelected(false);
        }
    ...
    private void jCheckBox20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox20ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox20.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel121.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox20.setSelected(false);
        }
    ...
    private void jCheckBox19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox19ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox19.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel115.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox19.setSelected(false);
        }
    ...
    private void jCheckBox18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox18ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox18.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel109.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox18.setSelected(false);
        }
    ...
    private void jCheckBox17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox17ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox17.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel103.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox17.setSelected(false);
        }
    ...
    private void jCheckBox16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox16ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox16.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel97.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox16.setSelected(false);
        }
    ...
    private void jCheckBox14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox14ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox14.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel85.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox14.setSelected(false);
        }
    ...
    private void jCheckBox13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox13ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox13.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel79.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox13.setSelected(false);
        }
    ...
    private void jCheckBox12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox12ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox12.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel73.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox12.setSelected(false);
        }
    ...
    private void jCheckBox11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox11ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox11.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel67.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox11.setSelected(false);
        }
    ...
    private void jCheckBox9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox9ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox9.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel55.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox9.setSelected(false);
        }
    ...
    private void jCheckBox8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox8ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox8.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel49.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox8.setSelected(false);
        }
    ...
    private void jCheckBox7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox7ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox7.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel43.getText() + "\t\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox7.setSelected(false);
        }
    ...
    private void jCheckBox6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox6ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox6.isSelected()) {
            ...
            double price = qty * 15.0;
            total += price;
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel37.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox6.setSelected(false);
        }
    ...
    private void jCheckBox5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox5ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox5.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel31.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox5.setSelected(false);
        }
    ...
    private void jCheckBox4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox4ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox4.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel25.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox4.setSelected(false);
        }
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox2.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel13.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox2.setSelected(false);
        }
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        ...
        if (qtyIsZero(qty) && jCheckBox1.isSelected()) {
            ...
            total += price;
            getTax((int) total);
            jTextArea.setText(jTextArea.getText() + x + ". " + jLabel7.getText() + "\t\t" + price + "00\n");
            dudate();
        } else {
            jCheckBox1.setSelected(false);
        }
    ...
    private void btnpmbyrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpmbyrActionPerformed
       if (total !=0 ) {
            if(!btnTotal.isEnabled()){
        String struk = jTextArea.getText();
        double tax = Double.parseDouble(jTextField2Tax.getText());
        double subTotal = Double.parseDouble(jTextField1sub.getText());
        double total = Double.parseDouble(jTextField3Total.getText());

// Panggil form pembayaran dan kirim data
        Pembayaran formPembayaran = new Pembayaran(struk, tax, subTotal, total);
    ...
    }//GEN-LAST:event_btnpmbyrActionPerformed

    private void jTextAreaComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jTextAreaComponentShown
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextAreaComponentShown
    ...
    private javax.swing.JButton btnpmbyr;
