...
public class LaporanPenjualan extends javax.swing.JFrame {
    ...
    try {
        ...
        Connection conn = Koneksi.getConnection(); // sesuaikan dengan method di Koneksi.java kamu
    ...
    try {
        ...
        double savingsTarget = 150000.0; // atau bisa jadi input juga
        ...
        // 5. Load data ke tabel dari database
        loadTransactionData();
