...
public class dashboardAdmin extends javax.swing.JFrame  {
  ...
  public dashboardAdmin() {
   ...
   private void initializePanels() {
    ...
    try {
        ...
        // Panel IdLaporan (menggantikan LaporanPenjualan)
        IdLaporan idLaporanFrame = new IdLaporan();
        Container idLaporanContent = idLaporanFrame.getContentPane();
        JPanel idLaporanPanel = new JPanel(new BorderLayout());
        idLaporanPanel.add(idLaporanContent, BorderLayout.CENTER);
        wadah.add(idLaporanPanel, "laporan");
  ...
  private void showIdLaporanPanel() {
    ...
    private void setupPanelListeners() {
        ...
        panelPenjualan.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                showIdLaporanPanel(); // atau tetap gunakan showLaporanPenjualanPanel()
            }
